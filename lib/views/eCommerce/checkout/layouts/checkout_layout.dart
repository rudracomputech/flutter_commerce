...
class _EcommerceCheckoutLayoutState
  ...
  Widget build(BuildContext context) {
    ...
    Stripe.publishableKey = 'pk_test_51RISFD000TiqKmsovQhaaedh1bSkfYuTdBZCTkq9yPxISXnfNeaIqbi2lCehG3Tff2UsaRqjyNjOllRjb4qoJG6E00dJuqWGAo';
                ...
                onPressed: () {
                  if (ref.watch(selectedDeliveryAddress) == null) {
                    ...
                    if (selectedPaymentType == PaymentType.cash) {
                     ...
                     // _placeOrder();
                      debugPrint('selectedPaymentType payable:'+ ref.read(cartSummeryController)['payableAmount'].toString());

 var  payableamt = ref.read(cartSummeryController)['payableAmount']*100;

                      makeStripePayment(payableamt.toStringAsFixed(0),'RON');

                      debugPrint('selectedPaymentType online: $selectedPaymentType');
                    } else {
                      if (pdfFilePath == null) {
                        GlobalFunction.showCustomSnackbar(
  ...
  Future<void> makeStripePayment(String amount, String currency)  async {
    try {
      ...
      await Stripe.instance
          .initPaymentSheet(
          paymentSheetParameters: SetupPaymentSheetParameters(paymentIntentClientSecret: paymentIntent!['client_secret'], merchantDisplayName: 'SecondHub'))
          .then((value) {});
  ...
  createPaymentIntent(String amount, String currency) async {
    ...
    Response response = await dio.post(
      ...
      options: Options(       headers: {
        'Authorization': 'Bearer  sk_test_51RISFD000TiqKmsoAhA2TmcFaDBzxeGXCAS3WX1jcB5rsesNQoiaI8mfCYTzeSe1N9D9FryH6N1q9Nc8s0ihrxEV00qGnoaZTH',
